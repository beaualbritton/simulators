# READ ME!!
##
This is a basic cache simulator I designed inComputer Archiecture course. Supports set-associative cache as well as direct map cache (when set associativity = 1). 
